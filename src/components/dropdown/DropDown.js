...
export class DropDown extends Component {
  ...
  render() {
    ...
    // todo: достать isOpen из this.state
            ...
            isOpen && (
                <div className="may-drop-down-options-wrapper dropdown-menu show">
                  {/*
                    ...
                    */}
                  {options.map(value => {
                    return <div className='may-drop-down-options-wrapper-option dropdown-item' key={value} data-value={value} onClick={this.onOptionSelect}>
                              {value}
                            </div>
                  })
                  }
