...
// done_todo: добавить state, в котором будет булевая пропертя isOpen по умолчанию = false
    ...
    render() {
        ...
        return (
            <div className="may-drop-down dropdown">
                ...
                <div className="btn btn-outline-dark dropdown-toggle" onClick={this.toggle}>{selectedOption}</div>

                {// done_todo: если значение isOpen в this.state = true показываем этот блок ниже (использовать &&)
                    isOpen && <div
                        className="may-drop-down-options-wrapper dropdown-menu show">
                        {
                            //*done_todo:
