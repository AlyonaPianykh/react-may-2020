...
const Footer = () => {
    return (
        <div className='may-footer'>
            ...
            <div className=''>All rights reserved. may-app © 2020</div>
        </div>
    )
}
...
//   в котором будет 2 div блока: 1й с классом "may-footer-content", второй будет без класса но с текстом
...
//   второй будет иметь класс "may-footer-social-media-wrapper", в него будут вложены 3 блока img в соответствии
//   с socialMediaIcons
