    ...
    return (
        <div className="may-footer">
            <div className="may-footer-content">
                <div>
                    <a>Some text about authors</a>
                </div>

                <div className="may-footer-social-media-wrapper">
                    <img src={socialMediaIcons[0].src} className="may-footer-social-media-icon" alt={socialMediaIcons[0].alt}></img>
                    <img src={socialMediaIcons[1].src} className="may-footer-social-media-icon" alt={socialMediaIcons[1].alt}></img>
                    <img src={socialMediaIcons[2].src} className="may-footer-social-media-icon" alt={socialMediaIcons[2].alt}></img>
                </div>
            </div>

            <div>
                <a>All rights reserved. may-app © 2020</a>
            </div>
        </div>
    )
}