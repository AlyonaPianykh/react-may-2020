...
//do здесь нужно сделать импорт socialMediaIcons из файла '../../constants'
import {socialMediaIcons} from '../../constants/index'
//do здесь нужно сделать импорт стилей из './Footer.scss'
import './Footer.scss'
import '../header/Header.scss'


// do здесь нужно сделать экспорт функии под названием Footer
export const Footer = () => {
    return (
        <div className="may-footer">
            <div className="may-footer-content">
                ...
                <div className="may-footer-social-media-wrapper">
                    ...
                    <img alt={socialMediaIcons[0].alt} src={socialMediaIcons[0].src}
                         className="may-footer-social-media-icon"/>

                    <img alt={socialMediaIcons[1].alt} src={socialMediaIcons[1].src}
                         className="may-footer-social-media-icon"/>

                    <img alt={socialMediaIcons[2].alt} src={socialMediaIcons[2].src}
                         className="may-footer-social-media-icon"/>
