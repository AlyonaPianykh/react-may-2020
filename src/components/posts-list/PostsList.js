...
class PostsList extends Component {
  state = {
    posts: [],
    isLoading: false
    // done 2: добавить isLoading индикатор
  };

  componentDidMount() {
    // done 2: вызвать загрузку постов
    this.loadPosts();
  }
  ...
  render() {
    // done 2: достать также лоадинг индикатор из стейта
    ...
    return (
      <div>
        ...
        {/* done 2: ниже добавить проверку если сейчас идет загрука то показываем лоадинг индикатор (как в задании 7)
