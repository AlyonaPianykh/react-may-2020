...
class PostsList extends Component {
  state = {
    posts: [],
    isLoading: false
    // todo 2: (done)добавить isLoading индикатор
  };

  componentDidMount() {
    // todo 2: (done)вызвать загрузку постов
    this.loadPosts()
  }
  ...
  render() {
    // todo 2: (done)достать также лоадинг индикатор из стейта
    ...
    return (
      <div>
        ...
        {/* todo 2: (done)ниже добавить проверку если сейчас идет загрука то показываем лоадинг индикатор (как в задании 7)
