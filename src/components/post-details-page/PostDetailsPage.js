...
class PostDetailsPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            post: null,
            // todo 3: (done)добавить isLoading флажок - индикатор загрузки
            isLoading: false
        };
    }

    componentDidMount() {
        // todo 3: (done)вызвать загрузку инфрмации про пост loadPost
        this.loadPost()
    }
    ...
    render() {
        ...
        //todo 3: (done)достать пост из стейта
        const { posts, isLoading } = this.state;
        return (
            <div>
                <div>Post Details Page</div>
                {
                    // todo 3: (done)если идет загрузка - показываем лоадинг индикатор
...
// // todo 3: (done)обратите внимание - если в App.js вы не передали routerProps в компоненту - то здесь нужно использовать withRouter
