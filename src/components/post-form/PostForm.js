...
class PostForm extends Component {
  ...
  //  2: добавить функцию onReset которая будет очищать форму
  ...
  onSubmit = (e) => {
    ...
    //  2: добавить очистку формы с помощью вызова функции onReset
    this.onReset();
  };
  ...
  render() {
    ...
    return (
      <form className="may-add-post-form" onSubmit={this.onSubmit}>
        ...
        {/*  2: добавить кнопку, по нажатию на которую будет вызываться метод onReset*/}
        <div className="m-2">
