...
class HomePage extends Component {
  ...
  onUserAdd = (newUser) => {
    ...
    // todo 2: (maybe done) тут будет использована action-функция добавления пользователя ( чтоб он попал в редаксовый стор)
    //  вместо изменения стейта
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {/*  todo 2: (maybe done) добавить тут рендер списка пользователей (чтоб видеть что пользователь добавляется)*/}
          {
            users.map(user => {
...
const mapStateToProps = state => {
  // todo: (maybe done) обратите внимание, что с появлением нескольких редьюсеров меняется уровень вложенности объекта стор
...
// todo: (maybe done) обратите внимание - эти 2 примера mapDispatchToProps равносильны, вы можете использовать любой из них
// todo: (maybe done) обратите внимание, ниже mapDispatchToProps это функция
...
// todo: (maybe done) обратите внимание, a тут это объект
