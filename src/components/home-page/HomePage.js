...
class HomePage extends Component {
  ...
  onUserAdd = (newUser) => {
    ...
    // d_todo 2: тут будет использована action-функция добавления пользователя ( чтоб он попал в редаксовый стор) вместо изменения стейта
    // this.setState({
    //   users: [{
    //     ...newUser,
    //     id: uniqueId()
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {/*  d_todo 2: добавить тут рендер списка пользователей (чтоб видеть что пользователь добавляется)*/}
