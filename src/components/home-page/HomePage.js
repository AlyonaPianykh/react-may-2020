...
class HomePage extends Component {
    ...
    onUserAdd = (newUser) => {
        ...
        // done_todo 2:  тут будет использована action-функция добавления пользователя ( чтоб он попал в редаксовый стор)
...
// done_todo:  обратите внимание - эти 2 примера mapDispatchToProps равносильны, вы можете использовать любой из них
// done_todo:  обратите внимание, ниже mapDispatchToProps это функция
...
// done+todo:  обратите внимание, a тут это объект
