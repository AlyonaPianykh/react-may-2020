...
class App extends Component {
    ...
    // donetodo: 3) обратите внимание на эту функцию, она уже написана,
    ...
    onSortByDefault = () => {
        this.setState({
            posts: [...postsList],
            selectedOption: sortingOptions[0] //  щоб також змінити значення в DropDown.js(59стр)
    ...
    onSortByAuthorClick = () => {
        ...
        this.setState({
            posts: sorted,
            selectedOption: sortingOptions[1] //  щоб також змінити значення в DropDown.js(59стр)
        });
            ...
            <div className="App">
                ...
                <PanelFromLecture label="Posts">
                    <div className="d-flex justify-content-around w-50">
                        Sorting:
                        <button onClick={this.onSortByAuthorClick}
                                className={`${this.state.selectedOption === sortingOptions[1] ? 'selected' : ''}`}>By
                            author</button>
                        <button onClick={this.onSortByDefault}
                                className={`${this.state.selectedOption === sortingOptions[0] ? 'selected' : ''}`}>By
                            default
                        </button>
