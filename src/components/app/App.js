      ...
      <div className="App">
        ...
        <PanelFromLecture label="Posts">
          <div className="d-flex">
            Sorting:
            <button className={`${selectedOption === 'Sort By Author'? 'activated': '' }`} onClick={this.onSortByAuthorClick}>By author</button>
            <button className={`${selectedOption === 'Sort By Default'? 'activated': '' }`} onClick={this.onSortByDefault}>By default</button>
