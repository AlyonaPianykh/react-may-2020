      ...
      <div className="App">
        ...
        <PanelFromLecture label="Posts">
          <div className="d-flex">
            Sorting:
            <button className = {`${selectedOption === 'Sort By Author'? 'active': '' }`}
                    onClick={this.onSortByAuthorClick}>By author
            </button>
            <button className = {`${selectedOption === 'Sort By Default'? 'active': '' }`}
                    onClick={this.onSortByDefault}>By default
            </button>
