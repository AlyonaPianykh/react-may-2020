...
// todo - (done maybe) 0) тут мы делаем импорт дропдауна (уже сделан)
import {DropDown} from '../dropdown/DropDown';
import './App.scss';
import 'bootstrap/dist/css/bootstrap.min.css';


// todo - (done maybe) 1) вот наши опции сортировки, мы будем их использовать в DropDown (уже объявлены)
const sortingOptions = ['Sort By Default', 'Sort By Author'];

class App extends Component {
    state = {
        posts: [...postsList],
        // todo - (done maybe) 2) добавить под ключом selectedOption значение sortingOptions[0] (она будет хранить выбранную в данный моменит опцию)
    ...
    // todo - (done maybe) 3) обратите внимание на эту функцию, она уже написана,
    ...
    render() {
        // todo - (done maybe) 4) достать также в строке 92 из стейта selectedOption
            ...
            <div className="App">
                ...
                <PanelFromLecture label="Posts">
                    <div className="d-flex">
                        ...
                        {/* todo - (done maybe) тут используется дропдаун
