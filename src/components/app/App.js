...
// oktodo 0) тут мы делаем импорт дропдауна (уже сделан)
...
// oktodo 1) вот наши опции сортировки, мы будем их использовать в DropDown (уже объявлены)
...
class App extends Component {
    state = {
        ...
        // oktodo: 2) добавить под ключом selectedOption значение sortingOptions[0] (она будет хранить выбранную в данный моменит опцию)
    };
    ...
    render() {
        // oktodo 4) достать также в строке 92 из стейта selectedOption
            ...
            <div className="App">
                ...
                <PanelFromLecture label="Posts">
                    <div className="d-flex">
                        ...
                        {/* oktodo: тут используется дропдаун
