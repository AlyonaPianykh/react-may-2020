...
// completetodo 0) тут мы делаем импорт дропдауна (уже сделан)
...
// completetodo 1) вот наши опции сортировки, мы будем их использовать в DropDown (уже объявлены)
...
class App extends Component {
  state = {
    ...
    // completetodo: 2) добавить под ключом selectedOption значение sortingOptions[0] (она будет хранить выбранную в данный моменит опцию)
  };
  ...
  // completetodo: 3) обратите внимание на эту функцию, она уже написана,
  ...
  render() {
    // completetodo 4) достать также в строке 92 из стейта selectedOption
      ...
      <div className="App">
        ...
        <PanelFromLecture label="Posts">
          <div className="d-flex">
            ...
            {/* completetodo: тут используется дропдаун
