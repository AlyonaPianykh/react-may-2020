...
import {Link} from 'react-router-dom'// dtodo 3: сделать импорт Link из react-router-dom
  ...
  render() {
    ...
    return (
      <div className={`may-post-card card ${className}`}>
        ...
        */}
        <div className={'d-flex justify-content-center'}><Link to={`${url}/${post.id}`}>Show details</Link></div>
