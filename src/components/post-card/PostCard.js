    ...
    return (
      <div className={`may-post-card card ${className}`}>
...

        {
          ...
          <label className='btn ntb-link' onClick={this.onToggleComments}>{showComments ? 'hide comments' : 'show comments'}</label>
        }
        ...
        {showComments && <label>Comments:</label>}
        {
          ...
          (showComments && isCommentsLoading) && <LoadingIndicator/>
