...
// done 3: сделать импорт Link из react-router-dom
...
class PostCard extends PureComponent {
  ...
  render() {
    //done 3 : достать ниже url из  props.match по аналогии с UserCard строка 7
    ...
    return (
      <div className={`may-post-card card ${className}`}>
        ...
        {/* done 3 : добавить ссылку Link на урлу с айди поста, где будут детали поста
...
// done 3: подвязать PostCard с помощью withRouter к роутеру по аналогии с UserCard
