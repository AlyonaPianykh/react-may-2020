...
// todos 3: сделать импорт Link из react-router-dom
    ...
    render() {
        ...
        return (
            <div className={`may-post-card card ${className}`}>
                ...
                {
                    <label onClick={this.onToggleComments}
...
// tdodo 3: подвязать PostCard с помощью withRouter к роутеру по аналогии с UserCard
