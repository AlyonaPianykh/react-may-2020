...
export function PostCard(props) {
  console.log(props);
  // done_todo: достать пропсу comments из props ниже в 9й строке
  ...
  return (
    ...
    {/*  done_todo: здесь нужно показать массив коментариев к посту (comments), который прилетит в props
    ...
    */}
      {comments && comments.map(item=>{
        return(
            <Comment key={item.id} newComment={item}/>
        )
      })}
