...
// donetodo 3: сделать импорт Link из react-router-dom
import { Link } from 'react-router-dom';
import { withRouter } from 'react-router';
import {accessToken, postsList} from '../../constants';
...
class PostCardComponent extends PureComponent {
  ...
  render() {
    //donetodo 3 : достать ниже url из  props.match по аналогии с UserCard строка 7
    ...
    return (
      <div className={`may-post-card card ${className}`}>
        ...
        {/* donetodo 3 : добавить ссылку Link на урлу с айди поста, где будут детали поста
...
// donetodo 3: подвязать PostCard с помощью withRouter к роутеру по аналогии с UserCard
