      ...
      <div className={`may-post-card card ${className}`}>
...

        {
          this.state.showComments
              ? (<label onClick={this.onToggleComments} className={"btn btn-link"}>Hide comments</label>)
              : (<label onClick={this.onToggleComments} className={"btn btn-link"}>Show comments</label>)
        }
