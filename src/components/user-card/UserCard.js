...
//done здесь нужно сделать импорт стилей из './UserCard.scss'


// done здесь нужно сделать экспорт функии под названием UserCard с аргументом props
...
export const UserCard = ({user})=>{
    ...
    return (
        <div className='may-user-card'>
            <img className="may-user-card-avatar rounded-circle" src={href} alt="Profile picture"/>
