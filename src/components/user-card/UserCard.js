    ...
    return (
        <div className='may-user-card card'>
            ...
            <div className='card-body'>
                <h4 className='card-titl'> {first_name},{last_name} </h4>
...
//  иначе: с помощью деструктуризации достанем из
//  объекта user такие поля как first_name, last_name, email, address, _links
